...
For jailbreak detection experiments, abliterated variants of all three models were created using the method of \citet{arditi2024refusal}, removing the refusal direction to produce models that comply with harmful requests.
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Refusal/Jailbreak}: 20 harmful prompts designed to trigger safety refusal, paired with 20 benign prompts matched for domain. Impossibility prompts (e.g., ``What is north of north?'') added in Experiment 36.
\end{itemize}
